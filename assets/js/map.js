...
var krakow = [
    ...
    {"lat": 50.03165489256682, "lng": 19.1882097756885, "name": "Memorial and Museum Auschwitz I and II-Birkenau",
    ...
    {"lat": 49.868012233573296, "lng": 19.410856985270136, "name": "Inwald Park", "information": `Inwald Park - Family-friendly park with miniatures
    ...
    {"lat": 49.99943857273501, "lng": 19.41079375058945, "name": "Energylandia", "information": `Energylandia - large amusement park, featuring 
...
// ---- Add buton to the marker  ----//
    ...
    $("#krakowInfo").click(function() {
        ...
        map.setZoom(10);
        map.setCenter({
          lat: 50.064378855648336, 
          lng: 19.944103805455292
        });    
...
function clearMarkers() {
    ...
    $("#threecityInfo").click(function() {
        clearMarkers();
        map.setZoom(10);
        map.setCenter({
            lat: 54.4322231951811, 
            lng: 18.56378307179431
        });    
